...
import com.sy.shoplist.shoplist.activity.MainActivity;
...
//                MyApplication.dao.deldepartments(sname);
                MyApplication.dao.delete_by_id(ids);
//                MyApplication.dao.delete_by_img(img);
        ...
        holder.btn_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                MyApplication.dao.Updateshop(num,ids);
            }
        });
