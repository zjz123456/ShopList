package com.sy.shoplist.shoplist.imageurl;
...
public class AmountView extends LinearLayout implements View.OnClickListener, TextWatcher {
    ...
    public AmountView(Context context, AttributeSet attrs) {
        ...
        etAmount = (EditText) findViewById(R.id.tv_num);
        btnDecrease = (Button) findViewById(R.id.btn_sub);
        btnIncrease = (Button) findViewById(R.id.btn_add);
